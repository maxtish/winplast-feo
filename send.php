...
$body = "
<h2>Заказ с сайта prookna82.ru</h2>
<b>Имя:</b> $name<br>
...
try {
   ...
   $mail->isSMTP();   
    ...
    $mail->SMTPSecure = 'ssl';
    $mail->Port       = 465;
    $mail->setFrom('parsingrd-max@yandex.ru', 'Заказ с сайта prookna82'); // Адрес самой почты и имя отправителя

    // Получатель письма
    $mail->addAddress('rd-max@yandex.ru');  
